...
// and runs them.  The output from the program indices the expected behavior.
...
public class TestTuringMachine {
	...
	public static void main(String[] args) {
		...
		tape.moveLeft(); // now, input is written on the tape, with the machine on the rightmost
							// character
