...
public class TextIO {
    ...
    * be the
    * end-of-file character (specfied by the constant TextIO.EOF).An end-of-line is
    * always returned
    ...
    * This method never causes an error. (Ordinarly, end-of-file is not possible
    * when reading from
    * standard input.)
    */
   ...
   private static String inputFileName; // Name of file that is the current input source, or null if the source is not a
                                        // file.
