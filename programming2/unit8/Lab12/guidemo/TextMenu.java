...
public class TextMenu extends JMenu {
	...
	private JRadioButtonMenuItem leftRadioButton;
	private ButtonGroup justifyButtonGroup;
	...
	private JMenu makeJustifyMenu() {
		...
		justifyButtonGroup = new ButtonGroup();

		// Create "Left" radio button
		leftRadioButton = new JRadioButtonMenuItem("Left");
		...
		justifyButtonGroup.add(leftRadioButton);
		justifyMenu.add(leftRadioButton);

		// Create "Right" radio button
		JRadioButtonMenuItem rightRadioButton = new JRadioButtonMenuItem("Right");
		...
		justifyButtonGroup.add(rightRadioButton);
		justifyMenu.add(rightRadioButton);

		// Create "Center" radio button
		JRadioButtonMenuItem centerRadioButton = new JRadioButtonMenuItem("Center");
		...
		justifyButtonGroup.add(centerRadioButton);
		justifyMenu.add(centerRadioButton);

		return justifyMenu;
	}

	private JMenuItem createLineHeightMenuItem() {
		JMenuItem lineHeightItem = new JMenuItem("Set Line Height...");
		lineHeightItem.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				String currentLineHeight = String.valueOf(panel.getTextItem().getLineHeightMultiplier());
				String newLineHeight = JOptionPane.showInputDialog(panel, "Enter the new line height multiplier:",
						currentLineHeight);
				if (newLineHeight != null && newLineHeight.trim().length() > 0) {
					try {
						...
						JOptionPane.showMessageDialog(panel,
								"Invalid line height multiplier.\nPlease enter a valid positive number.");
					}
				}
			}
		});
